...
telecom_users= pd.read_csv('telecom_users.csv', delimiter = ';').dropna()
telecom_users_eval = pd.read_csv('telecom_users_eval.csv', delimiter = ';').dropna()
...
X = telecom_users[features].values
y = telecom_users[['sortie_client']].values.flatten()
